        ...
        <Row className="align-items-center">
          <Col lg="6" className="pl-lg-5 order-lg-2">
            <div className="feature-content section-title">
              <Title color="light">¿Qué hacemos?</Title>
              <Text color="light" opacity={0.7} mb={4}>
                Todos nuestros proyectos Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras nulla neque, dapibus at velit sed, scelerisque dignissim arcu. Sed lectus ligula, commodo eget elit ut, ullamcorper accumsan ex. Integer eget consectetur augue. Nam convallis sapien massa, sed varius lorem bibendum vitae. Suspendisse sed iaculis enim. Vivamus eu magna ante. Sed tristique sodales sem id imperdiet. Etiam molestie turpis dui, ac viverra orci mattis ut. Etiam tincidunt dolor non hendrerit suscipit. 
              </Text>
