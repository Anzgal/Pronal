            ...
            <Col lg="7" className="order-lg-1">
              ...
              >
                <Box py={[null, null, null, 5]} pr={5} pt={[4, null]}>
                  <Title variant="hero">
                    Depósitos y obturadores
                  </Title>
                  <Text mb={4}>
                    Somos una empresa especializada en Lorem ipsum dolor sit amet. 
                    Etiam vehicula eu lacus at rhoncus. Maecenas finibus, erat vitae
                    venenatis viverra, sapien dui bibendum quam.
                  </Text>
                  <div className="d-flex flex-column align-items-start">
                    <Link href="/contacto">
                     <Button mt={3}>Contáctanos</Button>
                    </Link>
                    <a
                      href="/"
                    ...
                    >
                      <Box color="secondary">
                        <i className="icon icon-triangle-right-17-2"></i> Ver video
                      </Box>
                    </a>
                  </div>
                </Box>
